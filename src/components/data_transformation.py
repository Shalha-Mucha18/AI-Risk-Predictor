...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        """
        creates a data transformer object for the data, 
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        # Load train and test data
           ...
           logging.info("Custom transformations applied to train and test df.")
           ...
           logging.info("Preprocessor applied to train and test df.")

           logging.info("Applying SMOTEEN for handaling imbalnced dataset ")

           smoteen = SMOTEENN(sampling_strategy=0.5, random_state=42)
           ...
           # SMOTEENN is only applied to training data to fix class imbalance.
           # The test set is kept as-is to preserve unbiased evaluation.
           input_feature_test_final, target_feature_test_final = input_feature_test_arr, target_feature_test_df

           logging.info("SMOTEEN applied to train df. Test set left unchanged.")
           ...
           logging.info("features and target combined")
           ...
           return DataTransformationArtifact(
            ...
            logging.exception("Exception occurred in initiate_data_transformation method of DataTransformation class")
            raise MyException(e, sys) from e
